        ...
        <el-col :xs="24" :lg="12">
          <div class="panel">
            ...
            <div class="panel-body">
              <ul class="tip-list">
                <li>医师在「用药记录」开具处方：每张处方仅一种药品，需选择患者；提交后状态为待发药，库存扣减在药剂师发药后进行。</li>
                <li>药剂师在「审批发药」核对患者用户 ID 后同意发药，系统将扣减库存；患者未取药时可拒绝待发药处方。</li>
                <li>药剂师在「药品列表」可进行入库与库存盘点；列表中的「预警状态」支持排序。</li>
                <li>「数据看板」内指标按时间窗口统计；在「数据趋势」中点击折线某日数据点，可查看当日已发药记录明细。</li>
                <li>撤销已发药处方会回滚库存；撤销待发药不涉及库存。请仅在确认无误后操作。</li>
          ...
          <div class="panel">
            ...
            <div class="panel-body">
              <ul class="tip-list">
                ...
                <li>医师与药剂师默认仅能查看<strong>本科室</strong>范围内的业务数据；管理员可查看全院数据。</li>
